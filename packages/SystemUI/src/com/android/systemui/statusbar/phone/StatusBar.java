...
*/
    ...
    public void updateTileStyle() {
        ...
        CorvusUtils.updateTileStyle(mOverlayManager, mLockscreenUserManager.getCurrentUserId(), qsTileStyle);
    }

    // Unload all qs tile styles back to stock
    public void stockTileStyle() {
        CorvusUtils.stockTileStyle(mOverlayManager, mLockscreenUserManager.getCurrentUserId());
    }
